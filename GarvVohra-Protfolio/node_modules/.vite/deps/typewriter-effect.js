...
//#region node_modules/typewriter-effect/dist/react.js
var require_react = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		"object" == typeof exports && "object" == typeof module ? module.exports = t(require_react$1()) : "function" == typeof define && define.amd ? define("Typewriter", ["react"], t) : "object" == typeof exports ? exports.Typewriter = t(require_react$1()) : e.Typewriter = t(e.react);
		...
		var t = {
			...
			1986: (e, t, r) => {
				...
				e.exports = function(e, t, r, n, c, l, f) {
					switch (r) {
						...
						case "[object ArrayBuffer]": return !(e.byteLength != t.byteLength || !l(new o(e), new o(t)));
						case "[object Boolean]":
						case "[object Date]":
						...
						case "[object Set]":
							...
							return f.delete(e), y;
						case "[object Symbol]": if (p) return p.call(e) == p.call(t);
					}
					return !1;
				};
			},
			...
			2428: (e, t, r) => {
				var n = r(7534), o = r(346), a = Object.prototype, i = a.hasOwnProperty, s = a.propertyIsEnumerable;
			...
			3146: (e, t, r) => {
				for (var n = r(3491), o = "undefined" == typeof window ? r.g : window, a = ["moz", "webkit"], i = "AnimationFrame", s = o["request" + i], u = o["cancel" + i] || o["cancelRequest" + i], c = 0; !s && c < a.length; c++) s = o[a[c] + "Request" + i], u = o[a[c] + "Cancel" + i] || o[a[c] + "CancelRequest" + i];
				if (!s || !u) {
			...
			4664: (e, t, r) => {
				var n = r(9770), o = r(3345), a = Object.prototype.propertyIsEnumerable, i = Object.getOwnPropertySymbols;
			...
			5861: (e, t, r) => {
				...
				(n && g(new n(/* @__PURE__ */ new ArrayBuffer(1))) != d || o && g(new o()) != p || a && g(a.resolve()) != l || i && g(new i()) != f || s && g(new s()) != v) && (g = function(e) {
			...
			7167: (e, t, r) => {
				var n = r(4901), o = r(7301), a = r(6009), i = a && a.isTypedArray;
				e.exports = i ? o(i) : n;
			},
			7217: (e, t, r) => {
			...
			9325: (e, t, r) => {
				var n = r(4840), o = "object" == typeof self && self && self.Object === Object && self;
			...
			9905: (e, t, r) => {
				...
				const a = function(e) {
					return (/* @__PURE__ */ new RegExp(/<[a-z][\s\S]*>/i)).test(e);
				}, i = function(e, t) {
				...
				const A = function() {
					function e(t, r) {
						...
						if (function(e, t) {
							...
							return _.addEventToQueue(l, { ms: e }), _;
							...
							return _.addEventToQueue(c, { speed: e }), _;
						})), O(this, "changeDeleteSpeed", (function(e) {
							if (!e) throw new Error("Must provide new delete speed");
							return _.addEventToQueue(d, { speed: e }), _;
						})), O(this, "changeDelay", (function(e) {
							if (!e) throw new Error("Must provide new delay");
							return _.addEventToQueue(h, { delay: e }), _;
						})), O(this, "changeCursor", (function(e) {
							if (!e) throw new Error("Must provide new cursor");
							return _.addEventToQueue(y, { cursor: e }), _;
								...
								if (!(t <= (r = a.eventName === p || a.eventName === u ? "natural" === _.options.deleteSpeed ? i(40, 80) : _.options.deleteSpeed : "natural" === _.options.delay ? i(120, 160) : _.options.delay))) {
									...
									switch (_.logInDevMode({
										...
										case f:
											...
											P.call(C, { elements: _.state.elements });
											break;
										case v:
										...
										case h:
											...
											break;
										case y: _.options.cursor = a.eventArgs.cursor, _.state.elements.cursor.innerHTML = a.eventArgs.cursor;
									}
					...
					}]) && E(t.prototype, r), Object.defineProperty(t, "prototype", { writable: !1 }), e;
				}();
			},
			9935: (e) => {
				e.exports = function() {
		...
		return (() => {
			...
			var d = function(e) {
				...
				function d() {
					...
					return t = p(e = a.call.apply(a, [this].concat(i))), n = { instance: null }, (r = v(r = "state")) in t ? Object.defineProperty(t, r, {
						value: n,
						enumerable: !0,
						configurable: !0,
						writable: !0
				...
				return n = d, (o = [
					...
					},
					{
						...
						value: function(e) {
							i()(this.props.options, e.options) || this.setState({ instance: new r.default(this.typewriter, this.props.options) });
						}
					},
					{
				...
				]) && u(n.prototype, o), Object.defineProperty(n, "prototype", { writable: !1 }), d;
			}(e.Component);
