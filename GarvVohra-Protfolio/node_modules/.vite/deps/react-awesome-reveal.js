...
import { n as memoize, t as require_hoist_non_react_statics_cjs } from "./hoist-non-react-statics.cjs-DgZoql-m.js";
...
var jsx$1 = function jsx(type, props, key) {
	if (!hasOwn.call(props, "css")) return import_jsx_runtime.jsx(type, props, key);
	return import_jsx_runtime.jsx(Emotion$1, createEmotionProps(type, props), key);
};
//#endregion
...
//#endregion
//#region node_modules/react-awesome-reveal/node_modules/react-intersection-observer/dist/index.mjs
...
//#endregion
//#region node_modules/react-awesome-reveal/node_modules/react-is/cjs/react-is.development.js
/**
* @license React
...
//#endregion
//#region node_modules/react-awesome-reveal/dist/index.js
...
var Reveal = (props) => {
	const { cascade = false, damping = .5, delay = 0, duration = 1e3, fraction = 0, keyframes = fadeInLeft, triggerOnce = false, className, style, childClassName, childStyle, children, onVisibilityChange } = props;
	const animationStyles = (0, import_react.useMemo)(() => getAnimationCss({
		keyframes,
		duration
	}), [duration, keyframes]);
	if (isNullable(children)) return null;
	if (isStringLike(children)) return /* @__PURE__ */ jsx$1(TextReveal, {
		...props,
		animationStyles,
		children: String(children)
	});
	if ((0, import_react_is.isFragment)(children)) return /* @__PURE__ */ jsx$1(FragmentReveal, {
		...props,
		animationStyles
	});
	return /* @__PURE__ */ jsx$1(Fragment, { children: import_react.Children.map(children, (node, index) => {
		if (!(0, import_react.isValidElement)(node)) return null;
		const nodeDelay = delay + (cascade ? index * duration * damping : 0);
		switch (node.type) {
			case "ol":
			case "ul": return /* @__PURE__ */ jsx$1(ClassNames, { children: ({ cx }) => /* @__PURE__ */ jsx$1(node.type, {
				...node.props,
				className: cx(className, node.props.className),
				style: Object.assign({}, style, node.props.style),
				children: /* @__PURE__ */ jsx$1(Reveal, {
					...props,
					children: node.props.children
				})
			}) });
			case "li": return /* @__PURE__ */ jsx$1(InView, {
				threshold: fraction,
				triggerOnce,
				onChange: onVisibilityChange,
				children: ({ inView, ref }) => /* @__PURE__ */ jsx$1(ClassNames, { children: ({ cx }) => /* @__PURE__ */ jsx$1(node.type, {
					...node.props,
					ref,
					className: cx(childClassName, node.props.className),
					css: matchIfOrNull(() => animationStyles)(inView),
					style: Object.assign({}, childStyle, node.props.style, hideWhen(!inView), { animationDelay: nodeDelay + "ms" })
				}) })
			});
			default: return /* @__PURE__ */ jsx$1(InView, {
				threshold: fraction,
				triggerOnce,
				onChange: onVisibilityChange,
				children: ({ inView, ref }) => /* @__PURE__ */ jsx$1("div", {
					ref,
					className,
					css: matchIfOrNull(() => animationStyles)(inView),
					style: Object.assign({}, style, hideWhen(!inView), { animationDelay: nodeDelay + "ms" }),
					children: /* @__PURE__ */ jsx$1(ClassNames, { children: ({ cx }) => /* @__PURE__ */ jsx$1(node.type, {
						...node.props,
						className: cx(childClassName, node.props.className),
...
var TextReveal = (props) => {
	const { animationStyles, cascade = false, damping = .5, delay = 0, duration = 1e3, fraction = 0, triggerOnce = false, className, style, children, onVisibilityChange } = props;
	const { ref, inView } = useInView({
		triggerOnce,
		threshold: fraction,
		onChange: onVisibilityChange
	});
	return matchIf(() => /* @__PURE__ */ jsx$1("div", {
		ref,
		className,
		style: Object.assign({}, style, textBaseStyles),
		children: children.split("").map((char, index) => /* @__PURE__ */ jsx$1("span", {
			css: matchIfOrNull(() => animationStyles)(inView),
			style: { animationDelay: delay + index * duration * damping + "ms" },
			children: char
		}, index))
	}), () => /* @__PURE__ */ jsx$1(FragmentReveal, {
		...props,
		children
	}))(cascade);
};
...
function getStyles$7(effect) {
	switch (effect) {
		case "bounce": return [bounce, { transformOrigin: "center bottom" }];
		case "flash": return [flash];
		case "headShake": return [headShake, { animationTimingFunction: "ease-in-out" }];
		case "heartBeat": return [heartBeat, { animationTimingFunction: "ease-in-out" }];
		case "jello": return [jello, { transformOrigin: "center" }];
		case "pulse": return [pulse, { animationTimingFunction: "ease-in-out" }];
		case "rubberBand": return [rubberBand];
		case "shake": return [shake];
		case "shakeX": return [shakeX];
		case "shakeY": return [shakeY];
		case "swing": return [swing, { transformOrigin: "top center" }];
...
var AttentionSeeker = (props) => {
	...
	const [keyframes, animationCss] = (0, import_react.useMemo)(() => getStyles$7(effect), [effect]);
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes,
...
function getStyles$6(reverse, direction) {
	switch (direction) {
		case "down": return reverse ? bounceOutDown : bounceInDown;
		case "left": return reverse ? bounceOutLeft : bounceInLeft;
		case "right": return reverse ? bounceOutRight : bounceInRight;
		case "up": return reverse ? bounceOutUp : bounceInUp;
		default: return reverse ? bounceOut : bounceIn;
	}
}
var Bounce = (props) => {
	const { direction, reverse = false, ...rest } = props;
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles$6(reverse, direction), [direction, reverse]),
		...rest
	});
};
...
function getStyles$5(big, reverse, direction) {
	switch (direction) {
		case "bottom-left": return reverse ? fadeOutBottomLeft : fadeInBottomLeft;
		case "bottom-right": return reverse ? fadeOutBottomRight : fadeInBottomRight;
		case "down": return big ? reverse ? fadeOutDownBig : fadeInDownBig : reverse ? fadeOutDown : fadeInDown;
		case "left": return big ? reverse ? fadeOutLeftBig : fadeInLeftBig : reverse ? fadeOutLeft : fadeInLeft;
		case "right": return big ? reverse ? fadeOutRightBig : fadeInRightBig : reverse ? fadeOutRight : fadeInRight;
		case "top-left": return reverse ? fadeOutTopLeft : fadeInTopLeft;
		case "top-right": return reverse ? fadeOutTopRight : fadeInTopRight;
		case "up": return big ? reverse ? fadeOutUpBig : fadeInUpBig : reverse ? fadeOutUp : fadeInUp;
		default: return reverse ? fadeOut : fadeIn;
	}
}
var Fade = (props) => {
	const { big = false, direction, reverse = false, ...rest } = props;
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles$5(big, reverse, direction), [
			big,
			direction,
			reverse
		]),
...
function getStyles$4(reverse, direction) {
	switch (direction) {
		case "horizontal": return reverse ? flipOutX : flipInX;
		case "vertical": return reverse ? flipOutY : flipInY;
		default: return flip;
	}
}
var animationCss$1 = { backfaceVisibility: "visible" };
var Flip = (props) => {
	const { direction, reverse = false, style, ...rest } = props;
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles$4(reverse, direction), [direction, reverse]),
...
`;
var animationCss = { transformOrigin: "top left" };
var Hinge = (props) => {
...
var Roll = (props) => {
	...
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles$3(reverse), [reverse]),
		...rest
	});
};
...
function getStyles$2(reverse, direction) {
	switch (direction) {
		case "bottom-left": return reverse ? [rotateOutDownLeft, { transformOrigin: "left bottom" }] : [rotateInDownLeft, { transformOrigin: "left bottom" }];
		case "bottom-right": return reverse ? [rotateOutDownRight, { transformOrigin: "right bottom" }] : [rotateInDownRight, { transformOrigin: "right bottom" }];
		case "top-left": return reverse ? [rotateOutUpLeft, { transformOrigin: "left bottom" }] : [rotateInUpLeft, { transformOrigin: "left bottom" }];
		case "top-right": return reverse ? [rotateOutUpRight, { transformOrigin: "right bottom" }] : [rotateInUpRight, { transformOrigin: "right bottom" }];
		default: return reverse ? [rotateOut, { transformOrigin: "center" }] : [rotateIn, { transformOrigin: "center" }];
	}
}
var Rotate = (props) => {
	const { direction, reverse = false, style, ...rest } = props;
	const [keyframes, animationCss] = (0, import_react.useMemo)(() => getStyles$2(reverse, direction), [direction, reverse]);
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes,
		style: Object.assign({}, style, animationCss),
		...rest
...
function getStyles$1(reverse, direction) {
	switch (direction) {
		case "down": return reverse ? slideOutDown : slideInDown;
		case "right": return reverse ? slideOutRight : slideInRight;
		case "up": return reverse ? slideOutUp : slideInUp;
		default: return reverse ? slideOutLeft : slideInLeft;
	}
}
var Slide = (props) => {
	const { direction, reverse = false, ...rest } = props;
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles$1(reverse, direction), [direction, reverse]),
		...rest
	});
};
...
function getStyles(reverse, direction) {
	switch (direction) {
		case "down": return reverse ? zoomOutDown : zoomInDown;
		case "left": return reverse ? zoomOutLeft : zoomInLeft;
		case "right": return reverse ? zoomOutRight : zoomInRight;
		case "up": return reverse ? zoomOutUp : zoomInUp;
		default: return reverse ? zoomOut : zoomIn;
	}
}
var Zoom = (props) => {
	const { direction, reverse = false, ...rest } = props;
	return /* @__PURE__ */ jsx$1(Reveal, {
		keyframes: (0, import_react.useMemo)(() => getStyles(reverse, direction), [direction, reverse]),
		...rest
	});
};
//#endregion
export { AttentionSeeker, Bounce, Fade, Flip, Hinge, JackInTheBox, Reveal, Reveal as default, Roll, Rotate, Slide, Zoom };
