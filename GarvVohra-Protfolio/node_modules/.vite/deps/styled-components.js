...
var v = function(e, t) {
	...
	return null !== t && "object" == typeof t && "[object Object]" === (t.toString ? t.toString() : Object.prototype.toString.call(t)) && !(0, import_react_is.typeOf)(t);
...
var N = "undefined" != typeof process && void 0 !== process.env && (process.env.REACT_APP_SC_ATTR || process.env.SC_ATTR) || "data-styled", A = "5.3.11", C = "undefined" != typeof window && "HTMLElement" in window, I = Boolean("boolean" == typeof SC_DISABLE_SPEEDY ? SC_DISABLE_SPEEDY : "undefined" != typeof process && void 0 !== process.env && (void 0 !== process.env.REACT_APP_SC_DISABLE_SPEEDY && "" !== process.env.REACT_APP_SC_DISABLE_SPEEDY ? "false" !== process.env.REACT_APP_SC_DISABLE_SPEEDY && process.env.REACT_APP_SC_DISABLE_SPEEDY : void 0 !== process.env.SC_DISABLE_SPEEDY && "" !== process.env.SC_DISABLE_SPEEDY ? "false" !== process.env.SC_DISABLE_SPEEDY && process.env.SC_DISABLE_SPEEDY : true)), P = {}, O = {
...
function ae(e) {
	var t, n, r, o, s = void 0 === e ? w : e, i = s.options, a = void 0 === i ? w : i, c = s.plugins, u = void 0 === c ? S : c, l = new stylis_min(a), d = [], p = function(e) {
		function t(t) {
			if (t) try {
				e(t + "}");
			} catch (e) {}
...
var ce = import_react.createContext(), ue = ce.Consumer, le = import_react.createContext(), de = (le.Consumer, new X()), he = ae();
function pe() {
...
function me(e) {
	var t = (0, import_react.useState)(e.stylisPlugins), n = t[0], s = t[1], c = pe(), u = (0, import_react.useMemo)((function() {
		var t = c;
		...
		e.sheet,
		e.target
	]), l = (0, import_react.useMemo)((function() {
		return ae({
	...
	}), [e.stylisPlugins]), import_react.createElement(ce.Provider, { value: u }, import_react.createElement(le.Provider, { value: l }, import_react.Children.only(e.children)));
}
var ye = function() {
	function e(e, t) {
		var n = this;
...
function _e(e, n, r, o) {
	...
	if (E(e)) {
		...
		var u = e(n);
		return (0, import_react_is.isElement)(u) && console.warn(b(e) + " is not a styled component and cannot be referred to via component selector. See https://www.styled-components.com/docs/advanced#referring-to-other-components for more details."), _e(u, n, r, o);
	}
	var l;
...
var Ce = /invalid hook call/i, Ie = /* @__PURE__ */ new Set(), Pe = function(e, t) {
	...
	try {
		...
		}, (0, import_react.useRef)(), o && !Ie.has(n) && (console.warn(n), Ie.add(n));
	} catch (e) {
...
var Me = import_react.createContext(), Ge = Me.Consumer;
function Le(e) {
	var t = (0, import_react.useContext)(Me), n = (0, import_react.useMemo)((function() {
		return function(e, t) {
			if (!e) return D(14);
			if (E(e)) {
				var n = e(t);
	...
	return e.children ? import_react.createElement(Me.Provider, { value: n }, e.children) : null;
}
var Fe = {};
function Ye(e, t, n) {
	...
	var A, C = new oe(n, v, o ? e.componentStyle : void 0), I = C.isStatic && 0 === c.length, P = function(e, t) {
		return function(e, t, n, r) {
			...
			}(Oe(t, (0, import_react.useContext)(Me), a) || w, t, o), m = p[0], v = p[1], g = function(e, t, n, r) {
				var o = pe(), s = fe(), i = t ? e.generateAndInjectStyles(w, o, s) : e.generateAndInjectStyles(n, o, s);
				return !t && r && r(i), i;
			}(i, r, m, e.warnTooManyClasses), S = n, b = v.$as || t.$as || v.as || t.as || h, _ = xe(b), N = v !== t ? y({}, t, {}, v) : t, A = {};
			for (var C in N) "$" !== C[0] && "as" !== C && ("forwardedAs" === C ? A.as = N[C] : (l ? l(C, isPropValid, b) : !_ || isPropValid(C)) && (A[C] = N[C]));
			return t.style && v.style !== t.style && (A.style = y({}, t.style, {}, v.style)), A.className = Array.prototype.concat(c, d, g !== d ? g : null, t.className, v.className).filter(Boolean).join(" "), A.ref = S, (0, import_react.createElement)(b, A);
		}(A, e, t, I);
	};
	return P.displayName = p, (A = import_react.forwardRef(P)).attrs = g, A.componentStyle = C, A.displayName = p, A.shouldForwardProp = N, A.foldedComponentIds = o ? Array.prototype.concat(e.foldedComponentIds, e.styledComponentId) : S, A.styledComponentId = v, A.target = o ? e.target : e, A.withComponent = function(e) {
	...
	}(p, v), Object.defineProperty(A, "toString", { value: function() {
		return "." + A.styledComponentId;
	} }), i && (0, import_hoist_non_react_statics_cjs.default)(A, e, {
		attrs: !0,
		componentStyle: !0,
		displayName: !0,
...
var qe = function(e) {
	return function e(t, r, o) {
		if (void 0 === o && (o = w), !(0, import_react_is.isValidElementType)(r)) return D(1, String(r));
		var s = function() {
		...
		return s.withConfig = function(n) {
			...
			return e(t, r, y({}, o, { attrs: Array.prototype.concat(o.attrs, n).filter(Boolean) }));
		}, s;
	}(Ye, e);
};
[
...
function $e(e) {
	...
	function d(e) {
		var t = pe(), n = fe(), o = (0, import_react.useContext)(Me), d = (0, import_react.useRef)(t.allocateGSInstance(a)).current;
		return import_react.Children.count(e.children) && console.warn("The global style component " + a + " was given child JSX. createGlobalStyle does not render children."), i.some((function(e) {
			return "string" == typeof e && -1 !== e.indexOf("@import");
		})) && console.warn("Please do not use @import CSS syntax in createGlobalStyle at this time, as the CSSOM APIs we use in production do not handle it well. Instead, we recommend using a library such as react-helmet to inject a typical <link> meta tag to the stylesheet, or simply embedding it manually in your index.html <head> section for a simpler app."), t.server && h(d, e, t, o, n), (0, import_react.useLayoutEffect)((function() {
	...
	function h(e, t, n, r, o) {
		if (u.isStatic) u.renderStyles(e, P, n, o);
			...
			var s = y({}, t, { theme: Oe(t, r, d.defaultProps) });
			u.renderStyles(e, s, n, o);
		}
	}
	return Pe(a), import_react.memo(d);
}
function We(e) {
...
var Ue = function() {
	function e() {
		...
		this._emitSheetCSS = function() {
			...
			var n = ((t = {})[N] = "", t["data-styled-version"] = "5.3.11", t.dangerouslySetInnerHTML = { __html: e.instance.toString() }, t), o = Y();
			return o && (n.nonce = o), [import_react.createElement("style", y({}, n, { key: "sc-0-0" }))];
		}, this.seal = function() {
			e.sealed = !0;
	...
	return t.collectStyles = function(e) {
		return this.sealed ? D(2) : import_react.createElement(me, { sheet: this.instance }, e);
	}, t.interleaveWithNodeStream = function(e) {
		return D(3);
	}, e;
}(), Je = function(e) {
	var t = import_react.forwardRef((function(t, n) {
		var o = (0, import_react.useContext)(Me), i = e.defaultProps, a = Oe(t, o, i);
		return void 0 === a && console.warn("[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class \"" + b(e) + "\""), import_react.createElement(e, y({}, t, {
			theme: a,
			ref: n
		}));
	}));
	return (0, import_hoist_non_react_statics_cjs.default)(t, e), t.displayName = "WithTheme(" + b(e) + ")", t;
}, Xe = function() {
